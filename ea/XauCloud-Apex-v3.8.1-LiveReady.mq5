//+------------------------------------------------------------------+
//|  XauCloud Apex v3.8.1 "LiveReady"                                  |
//|                                                                   |
...
//|                                                                   |
//|  v3.8.1 keeps the tested v3.8.0 strategy and adds live/demo operational repairs.
...
#define APEX_VERSION       "XauCloud-Apex_v3.8.1-LiveReady"
#define APEX_BUILD_ID      "3.8.1"
...
string ExecutionProfile()
  {
   if(campState==CAMP_ACTIVE||campState==CAMP_CLOSING) return P.accountProfile;
   return C.accountProfile;
  }
