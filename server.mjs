...
function settingsView(c){return {
  ...
  unlimitedSizingNote:'L1 '+c.normalL1MarginPct+'%, L2 '+c.normalL2MarginPct+'%, L3+ '+c.normalL3PlusMarginPct+'%. v3.9.2 requires fresh direction plus a new closed-candle confirmation before L1; the existing margin ladder and broker-capacity engine are preserved.',
  advanced:{strategy:'CONFIRMED_DIRECTION_BREAKOUT_TREND',entryScore:c.entryScore,addScore:c.addScore,watchExpiryMinutes:c.watchExpiryMinutes,
...
async function buildMe(key){
  ...
  return {
    ...
    effectiveConfig:{
      ...
      strategy:'CONFIRMED_DIRECTION_BREAKOUT_TREND',
