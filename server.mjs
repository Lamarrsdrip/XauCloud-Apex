...
const DEFAULT={armed:false,account:'0',symbolContains:'XAUUSD',targetMode:'MULTIPLIER',targetEquity:1000,targetMultiplier:100,baseMarginPct:15,layerMultiplier:2,maxLayers:0,entryScore:76,addScore:70,impulseAtr:1.8,sweepAtr:.05,rejectionBars:5,watchExpiryMinutes:12,addSpacingAtr:.22,rejectionZoneAtr:.12,requireM3Confirm:true,requireM5Context:false,cooldownMinutes:0,learningEnabled:true,learningMinCampaigns:8,learningMaxScoreAdjustment:5};
