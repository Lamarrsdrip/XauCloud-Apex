...
function settingsView(c){return {
  ...
  unlimitedSizingNote:'L1 '+c.normalL1MarginPct+'%, L2 '+c.normalL2MarginPct+'%, L3+ '+c.normalL3PlusMarginPct+'%. v3.9.3 requires fresh direction plus a NEW closed M1 confirmation before L1; the existing margin ladder and broker-capacity engine are preserved.',
