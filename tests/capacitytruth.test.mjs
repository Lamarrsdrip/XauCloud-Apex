...
test('the canonical and versioned EA files are byte-identical',()=>{
  ...
  assert.equal(version.versionedEaFile,'ea/XauCloud-Apex-v3.9.0-FailedBreakout.mq5');
...
test('version.json, the EA banner and #property version all agree',()=>{
  assert.equal(version.version,'3.9.0');
...
test('canonical EA is v3.9.0 FailedBreakout with v3.8.2 CapacityTruth trading intact',()=>{
  ...
  assert.match(ea,/DeadThesisBlocks/);
});
