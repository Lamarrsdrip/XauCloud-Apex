...
test('v3.9.3 starts L1 only after fresh-direction-aligned CLOSED setup confirmation', () => {
  assert.match(s, /if\(s\.valid\)\s*Start\(s\);/);
  assert.match(s, /strategy=CONFIRMED_DIRECTION_BREAKOUT_TREND \| entry=closed-confirmation-v3\.9\.3/);
